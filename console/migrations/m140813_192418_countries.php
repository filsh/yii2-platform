...
class m140813_192418_countries extends \yii\db\Migration
{
    public function up()
    {
        ...
        $this->createTable(Countries::tableName(), [
            ...
            'postal_code_format' => Schema::TYPE_STRING . '(255) NOT NULL DEFAULT ""',
            'postal_code_regex' => Schema::TYPE_STRING . '(255) NOT NULL DEFAULT ""',
            'languages' => Schema::TYPE_STRING . '(255)',
            'geoname_id' => Schema::TYPE_INTEGER . ' DEFAULT NULL',
            'neighbours' => Schema::TYPE_STRING . '(255) NOT NULL DEFAULT ""',
            'equivalent_fips_code' => Schema::TYPE_STRING . '(10) NOT NULL DEFAULT ""',
